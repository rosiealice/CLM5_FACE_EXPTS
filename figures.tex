  ...
  \end{figure}
   ...
   \begin{figure}[h]
    % \centering\includegraphics[width=0.5\textwidth, right]{lion-lo9
     ...
     \caption{Influence of parametric variation (over the range tested: -1 to +1) on the influence of 15 uears of Nitrogen fertilization (+5 kgN m$^{2}$ y$^{-1}$) at Caxiuana}
     \label{CAX ndep}
  \end{figure}
   ...
   \begin{figure}[h]
    % \centering\includegraphics[width=0.5\textwidth, right]{lion-lo9
     ...
     \caption{Influence of parametric variation (over the range tested: -1 to +1) on the influence of 15 years of CO$_{2}$ fertilization (550ppm) at Caxiuana }
     \label{CAX celev}
  \end{figure}
